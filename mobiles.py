...
with mlflow.start_run():
    # Build a Gradient Boosting Classifier model (replace RandomForestClassifier)
    ...
    print("Model trained successfully with Gradient Boosting Classifier.")
    ...
    print("Model logged to MLflow with Gradient Boosting Classifier.")
